...
The core of wacho consists of three reactive primitves: **PulseNode** for mutable state, **ComputedNode** for derived values, and **EffectNode** for side effects. Together they form a reactive dependency graph where updates propogate automatically.
