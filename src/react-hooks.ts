 ...
 * ---------
 *
 * Subscribes a React component to a wacho pulseNode and returns its
 * current value.
 *
 ...
 * re-executes whenever its wacho pulse dependencies change.
 *
 * This is the wacho equivalent of React's useEffect, but dependency
 ...
 *   useEffectpulse → deps are tracked automatically, wacho re-runs on pulse changes
 *
 ...
 * -------------------
 *
 * wacho's equivalent of React's useTransition, implemented using
 * concurrent lanes.
 *
