  ...
  return (
    <div className="dashboard">
      <div className="dashboard-header">
        <div>
          <div className="dashboard-title">
            <span className="highlight">wacho + React</span> — Portfolio
          </div>
    ...
    <div className="scoreboard">
      ...
      <div className="score-grid">
        ...
        <div className="score-card laneX">
          <div className="score-card-header">wacho + React</div>
  ...
  return (
    <div className="app">
      <div className="header">
        <h1><span>wacho + React</span> Performance Demo</h1>
      ...
      <div className="main-layout">
        ...
        <div className="side-panel">
          <div className="stat-panel">
            ...
            <div className="stat-row">
              <span className="stat-label">wacho + React renders/tick</span>
            ...
            <div className="stat-row">
              <span className="stat-label">wacho + React avg</span>
              <span className="stat-val">{zoStats.avgMs.toFixed(2)}ms</span>
            </div>
          </div>

          <div className="explanation">
            <h3>Why wacho + React wins</h3>
            <p>
            ...
            <br />
            <p>
              <span className="highlight">wacho + React</span> gives each coin its own
